...
const MyOrders = () => {
  ...
  const filteredOrders = myOrders
    ...
    .filter(
      (order) =>
        ...
        order?.orderStatus?.toLocaleLowerCase().includes(searchTerm)
    )
    .filter(
      (order) =>
        date === "" ||
  ...
  return (
    <>
      <Navbar />
      <div className="antialiased font-sans bg-white pt-20">
        <div className="container mx-auto px-4 sm:px-8">
          <div className="py-8">
            ...
            <div className="my-4 flex flex-col sm:flex-row sm:items-center sm:gap-4 gap-2">
              {/* Status Dropdown */}
              <div className="relative w-full sm:w-auto">
                <select
                  ...
                  className="w-full sm:w-48 rounded border border-gray-300 bg-white py-2 pl-4 pr-10 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-400"
                >
              ...
              <div className="relative w-full sm:w-64">
                ...
                <input
                  ...
                  placeholder="Search"
                  className="w-full rounded border border-gray-300 bg-white py-2 pl-10 pr-4 text-sm text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400"
                />
              </div>
              ...
              <div className="relative w-full sm:w-48">
                <input
                  ...
                  className="w-full rounded border border-gray-300 bg-white py-2 px-4 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-400"
                />
              </div>
            </div>
